...
async function testValidationMiddleware() {
  ...
  try {
    ...
    console.log(
      "  - Expected error: \"typeofcontent is required and must be either 'public' or 'personalized'\""
    );
    ...
    console.log(
      "  - typeofcontent: ✅ (optional, valid enum value: personalized)"
    );
    ...
    console.log(
      "  - Expected error: \"typeofcontent must be either 'public' or 'personalized'\""
    );
    ...
    console.log(
      "  ✅ validateAssetFileUpdate: typeofcontent is optional but validated"
    );
    console.log("  ✅ validateAssetFileVersion: typeofcontent is required");
    console.log(
      '  ✅ All validation rules accept only "public" or "personalized"'
    );
  } catch (error) {
...
async function testControllerIntegration() {
  ...
  try {
    ...
    console.log("\n📋 New Features:");
    console.log(
      "  ✅ typeofcontent field is required in createAssetFileVersion"
    );
    console.log(
      "  ✅ typeofcontent field is validated in all creation/update operations"
    );
...
async function testRouteConfiguration() {
  ...
  try {
    ...
    console.log(
      "  - GET /api/asset-files/organization/:organizationId/content-type/:contentType"
    );
...
async function main() {
  ...
  try {
    switch (command) {
      ...
      default:
        console.log(
          "Usage: node testControllerValidation.js [validation|controller|routes|all]"
        );
