...
// Fetch live phone number health (quality rating, messaging tier, name status)
router.get('/:organizationId/whatsapp-health',
  authorize('super_admin', 'system_admin', 'organization_admin'),
  validateUUID('organizationId'),
  authorizeOrganization,
  organizationController.getWhatsAppHealth
);

// Get WhatsApp Business Profile
router.get('/:organizationId/whatsapp-profile',
  authorize('super_admin', 'system_admin', 'organization_admin'),
  validateUUID('organizationId'),
  authorizeOrganization,
  organizationController.getBusinessProfile
);

// Update WhatsApp Business Profile
router.put('/:organizationId/whatsapp-profile',
  authorize('super_admin', 'system_admin', 'organization_admin'),
  validateUUID('organizationId'),
  authorizeOrganization,
  organizationController.updateBusinessProfile
);
