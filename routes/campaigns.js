...
router.post('/:campaignId/submit-approval', 
  authorize('super_admin', 'system_admin', 'organization_admin'),
  validateUUID('campaignId'),
...
router.post('/:campaignId/approve', 
  authorize('super_admin', 'system_admin'),
  validateUUID('campaignId'),
...
router.get('/:campaignId/audience', 
  authorize('super_admin', 'system_admin', 'organization_admin', 'organization_user'),
  validateUUID('campaignId'),
  validatePagination,
...
router.post('/:campaignId/audience', 
  authorize('super_admin', 'system_admin', 'organization_admin'),
  validateUUID('campaignId'),
  validateBulkAudience,
...
router.delete('/:campaignId/audience', 
  authorize('super_admin', 'system_admin', 'organization_admin'),
  validateUUID('campaignId'),
  validateRemoveAudience,
...
router.put('/audience/:campaignAudienceId/status', 
  authorize('super_admin', 'system_admin'),
