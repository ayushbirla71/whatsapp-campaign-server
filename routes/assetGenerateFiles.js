...
// Get asset files by content type for an organization
router.get(
  "/organization/:organizationId/content-type/:contentType",
  authorize(
    "super_admin",
    "system_admin",
    "organization_admin",
  ...
  validatePagination,
  authorizeOrganization,
  assetGenerateFilesController.getAssetFilesByContentType
);
...
// Get file versions
router.get(
  "/template/:templateId/versions/:fileName",
  authorize(
    "super_admin",
    "system_admin",
    "organization_admin",
